...
#   conference → cmt-edas, confOf-ekaw, human-mouse
#
...
#   tests/article_scenarios/s3.sh --label turn1 --only cmt-edas  # single dataset backfill
...
echo "    datasets:    conference→cmt-edas, confOf-ekaw, human-mouse"
