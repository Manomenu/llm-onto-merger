...
OAEI_EXTRA_S5=(confOf-ekaw)                     # OAEI needs this extra dataset's s5 run
S6_DATASETS=(cmt-edas confOf-ekaw human-mouse)  # reference-input runs (OAEI)
...
for T in "${TURNS[@]}"; do
  for ds in "${CORE_DATASETS[@]}" "${OAEI_EXTRA_S5[@]}"; do
