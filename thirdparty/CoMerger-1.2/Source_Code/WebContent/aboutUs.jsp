								...
								<table>
									<tr>
										<td style="text-align: justify;"><h2>Samira Babalou</h2>
											<h4>PhD student</h4> Samira Babalou is a current PhD student
											at the Heinz-Nixdorf-Professur for Distributed Information
											Systems at Friedrich-Schiller-University Jena. <br> Her
											interesting research topics includes semantic web, ontology
				...
				<td style="width: 100%"><table>
						<tr>
							<td style="width: 25%"><img
								...
								alt="Prof. Dr. Birgitta König-Rie" style="width: 250px"></td>
							<td style="width: 75%">
								<table>
									<tr>
										<td style="text-align: justify;"><h2>Prof. Dr.
												Birgitta König-Ries</h2>
											<h4>Professor</h4> Birgitta König-Ries holds the
											Heinz-Nixdorf Chair for Distributed Information Systems at
											Friedrich-Schiller-University Jena. Before joining FSU, she
											was working with the TU Munich, Universität Karlsruhe (this
											...
											includes: portal technology, context-aware, adaptive portals,
											semantic web, semantic web services, and data management for
		...
		<div id="publication" name="publication">
			...
			<ul>
				<li><b>A Subjective Logic based Approach to Handling
					...
					König-Ries. In OTM Confederated International Conferences On the
				...
				<li><b>GMRs: Reconciliation of Generic Merge Requirements
						in Ontology Integration</b>. Samira Babalou, Birgitta König-Ries.
				...
				<li><b>Why the mapping process in ontology integration
					...
					Lantow, Birgitta König-Ries. Proceedings of the 19th International
					Conference on Information Integration and Web-based Applications &
					Services</li>
				<li><b>An Ontology-based Scientific Data Integration
						Workflow</b>. Samira Babalou, Alsayed Algergawy, Birgitta König-Ries.
				...
				<li><b>A Particle Swarm-Based Approach for Semantic
					...
					Birgitta König-Ries. In OTM Confederated International Conferences
					On the Move to Meaningful Internet Systems (pp. 161-179). Springer,
					Cham. 2017.
			</ul>
		</div>
		</main>
